...
function M.add(token_id, amount, reason, visual_later)
	token.add(const.WALLET_CONTAINER, token_id, amount, reason, visual_later)
end
...
function M.add_many(tokens, reason)
	token.add_many(const.WALLET_CONTAINER, tokens, reason)
end
...
function M.add_group(token_group_id, reason)
	token.add_group(const.WALLET_CONTAINER, token_group_id, reason)
end
...
function M.set(token_id, amount, reason)
	token.set(const.WALLET_CONTAINER, token_id, amount, reason)
end
...
function M.get(token_id, amount)
	token.get(const.WALLET_CONTAINER, token_id, amount)
end
...
function M.pay(token_id, amount, reason)
	token.pay(const.WALLET_CONTAINER, token_id, amount, reason)
end
...
function M.pay_many(tokens, reason)
	token.pay_many(const.WALLET_CONTAINER, tokens, reason)
end
...
function M.pay_group(token_group_id, reason)
	token.pay_group(const.WALLET_CONTAINER, token_group_id, reason)
end
...
function M.is_enough(token_id, amount)
	token.is_enough(const.WALLET_CONTAINER, token_id, amount)
end
...
function M.is_enough_many(tokens)
	token.is_enough_many(const.WALLET_CONTAINER, tokens)
end
...
function M.is_enough_group(token_group_id)
	token.is_enough_group(const.WALLET_CONTAINER, token_group_id)
end
...
function M.is_max(token_id)
	token.is_max(const.WALLET_CONTAINER, token_id)
end
...
function M.is_empty(token_id)
	token.is_empty(const.WALLET_CONTAINER, token_id)
end
...
function M.add_infinity_time(token_id, seconds)
	token.add_infinity_time(const.WALLET_CONTAINER, token_id, seconds)
end
...
function M.is_infinity(token_id)
	token.is_infinity(const.WALLET_CONTAINER, token_id)
end
...
function M.get_infinity_seconds(token_id)
	token.get_infinity_seconds(const.WALLET_CONTAINER, token_id)
end
...
function M.sync_visual(token_id)
	token.sync_visual(const.WALLET_CONTAINER, token_id)
end
...
function M.add_visual(token_id, amount)
	token.add_visual(const.WALLET_CONTAINER, token_id, amount)
end
...
function M.get_visual(token_id)
	token.get_visual(const.WALLET_CONTAINER, token_id)
end
...
function M.get_seconds_to_restore(token_id)
	token.get_seconds_to_restore(const.WALLET_CONTAINER, token_id)
end
