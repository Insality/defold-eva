...
return function()
	describe("Section", function()
		...
		it("It should correct start and end festival", function()
			...
			assert(not eva.festivals.is_active_festival("event_festival"))
			assert(not eva.festivals.is_active_festival("weekly_festival"))
			assert(mock_cb.callback.calls == 0)

			set_time("2019-10-07T10:00:00Z")
			assert(not eva.festivals.is_active_festival("event_festival"))
			assert(eva.festivals.is_active_festival("weekly_festival"))
			...
			assert(eva.festivals.is_active_festival("event_festival"))
			assert(not eva.festivals.is_active_festival("weekly_festival"))
